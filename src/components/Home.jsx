...
import bgImage from "../assets/images/Jawa-12-1.webp";
  ...
  return (
    ...
    >
      <div className="mt-20">
        ...
        <h2 className="ginger  text-5xl">Dwi & Imam</h2>
      </div>
      <div className="mb-20 flex flex-col justify-center items-center gap-3">
        ...
        <button
          ...
          className="flex font-semibold items-center gap-2 px-10 py-2 mb-5 border-2 border-solid rounded-[20px]  bg-gradient-to-r from-[#D7BB83] to-[#A38C5E] w-1/2"
        >
          <FaLeaf />
          Buka Undangan
        </button>
